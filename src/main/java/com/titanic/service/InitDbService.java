...
//		if(eRepo.findById(1) == null) {
			...
			newUser.setRoleId(1);
			newUser.setRole(rRepo.findById(1));
			urepo.save(newUser);
			
			Employee newEmployee = new Employee();
			newEmployee.setId(1);
			newEmployee.setUser(newUser);
			newEmployee.setBranch(bRepo.findById(1));
