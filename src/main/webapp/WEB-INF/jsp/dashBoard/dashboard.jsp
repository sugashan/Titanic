...
<!-- jvectormap -->
<script type="text/javascript" src="<c:url value="/resources/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" />"></script>
...
<!-- AdminLTE App -->
<script type="text/javascript" src="<c:url value="/resources/dist/js/app.min.js.js" />"></script>
...
<script src="<c:url value="/resources/dist/js/app.min.js"/>"></script>
  ...
  if(dashInfo != "" || dashInfo != null){
	  console.log(dashInfo.newOrders);
  }
