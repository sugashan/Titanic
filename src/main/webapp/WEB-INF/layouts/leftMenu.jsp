...
<%--           	 <li class = "${current == 'employee' ? 'active' : '' }"><a href="/employee.html?token="><i class="fa fa-circle-thin"></i><span> Employees</span></a></li> --%>
           
<%--             <li class = "${current == 'customer' ? 'active' : '' }"><a href="/customer.html?token="><i class="fa fa-circle-thin"></i><span> Customers</span></a></li> --%>
<!--           </ul> -->
<!--         </li> -->
		
<%-- 	   <li class="treeview ${current == 'vehicle' ? 'active' : '' }"> --%>
<!--           <a href="/vehicle.html?token="><i class="fa fa-car"></i><span> Vehicles</span></a> -->
<!--         </li> -->

<%--           <li class="treeview ${current == 'route' ? 'active' : '' }"> --%>
<!--           <a href="/route.html?token="><i class="fa fa-road"></i><span> Routes</span></a> -->
<!--         </li> -->
		  <li class="treeview">
